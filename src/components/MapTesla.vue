<template>
  <l-map ref="map" :zoom="zoom" :center="center">
    ...
    <l-marker v-for="(marker, index) in markers" :key="index" :lat-lng="[marker.AddressInfo.Latitude, marker.AddressInfo.Longitude]" ></l-marker>
  </l-map>
</template>
